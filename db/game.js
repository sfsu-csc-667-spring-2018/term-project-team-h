...
const UPDATE_GAME_POT = 'UPDATE games SET game_pot=$1 WHERE game_id=$2 RETURNING *';
const GET_GAME_POT = 'SELECT game_pot FROM games WHERE game_id=$1 RETURNING *';
const UPDATE_CARDS_PLAYED = 'UPDATE games SET cards_played=$1 WHERE game_id=$2 RETURNING *';
const GET_CARDS_PLAYED = 'SELECT cards_played WHERE game_id=$1 RETURNING *';
